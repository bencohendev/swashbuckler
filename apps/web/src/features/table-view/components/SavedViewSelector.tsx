...
import { serializeFilters, deserializeFilters } from '../stores/filterConfig'
...
export function SavedViewSelector({
  ...
  const handleApply = useCallback((view: SavedView) => {
    const viewFilters = deserializeFilters(view.filters)
    onApplyView(viewFilters, view.sort, view.view_mode as ViewMode, view.board_group_field_id)
  }, [onApplyView])
  ...
  }, [onCreateView, filters, sort, viewMode, boardGroupFieldId, typeId])
