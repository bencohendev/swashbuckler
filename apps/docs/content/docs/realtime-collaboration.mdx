...
In addition to text cursors, you can see collaborators' **mouse pointers** moving across the document in real time. If you find mouse cursors distracting, you can toggle them off:

- **From the editor** — click the mouse pointer icon in the entry header (next to the collaborator avatars). The button appears only during collaborative sessions.
- **From account settings** — toggle "Show collaborator mouse cursors" in the Preferences section.

This preference persists across sessions. Toggling mouse cursors off hides other users' mouse pointers but **text selection cursors remain visible** so you can still see where collaborators are typing.
