...
| Date | Bug | Fix |
|------|-----|-----|
| 2026-02-25 | Table hover controls disappear before reachable | Extend hover zone with padding/negative-margin to cover handle areas; always render handles in DOM with opacity toggle instead of conditional mount |
