...
| Failing tests | 18 tests failing across 4 files (local.test.ts, validation.test.ts, ObjectItem.test.tsx, useObjects.test.tsx) — stale schemas/fixtures from remove-builtins migration and spaces changes | Closed |
