...
export function GraphNodeDetail({ nodes, onNavigate }: GraphNodeDetailProps) {
  ...
  return (
    <Card role="region" aria-label="Selected node details" className="absolute bottom-2 left-2 right-2 w-auto shadow-lg bg-background/95 backdrop-blur-sm md:bottom-9 md:left-auto md:right-9 md:w-64">
